...
categories: [ecg, hrv, physionet, contrast, mitdb, verified]
...
No claim value on this page changed.

Record 117, which carries this case's claims, is **unchanged to
ten decimal places** — its clean bradycardic QRS morphology left the detector
unaffected by the offset. The secondary contrast records did move slightly
(115: mean RR 924.3 -> 924.7 ms; 103: 868.6 -> 868.8 ms) and were re-derived,
and the replay bundle was refreshed so its evidence comes from the corrected
reader. The spectrum's findings — the 40.4 bpm span, the monotonic ordering,
the reciprocal HR/RR identity and the 2.5-fold SDNN spread — all hold.
